            ...
            <div class="row align-items-center">
                        ...
                        <ul>
                            <li>
                                ...
                                <ul class="language-dropdown">
                                    <li><a href="#"><img src="" alt="">Tiếng việt</a></li>
                ...
                <div class="col-xl-3 col-lg-4">
                    <div class="header-info header-info-right">
                        <ul>
                            <li><i class="fi-rs-key"></i><a href="login.html">Đăng nhập </a> / <a
            ...
            <div class="header-wrap">
                ...
                <div class="header-right">
                    ...
                    <form action="{{ route('search') }}" method="GET" class="d-flex">
                        <input type="text" name="query" placeholder="Search for products..." class="form-control mt-1" required>
                        <button type="submit" class="btn btn-primary mb-3" >Tìm Kiếm</button>
                    </form>
                 {{-- Lọc  --}}
                    <div class="roww">
                        <form action="{{ route('user.products.list_products') }}" method="GET">
